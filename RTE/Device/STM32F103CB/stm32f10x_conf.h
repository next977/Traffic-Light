...
extern void delay_s(uint16_t delay);
  
extern uint32_t delay_time;
extern uint32_t delay_stime;
  
extern uint32_t button_time;
extern uint32_t button_time2;
 extern uint32_t button_time3;
extern uint32_t Sensor_Mode;
extern int Sensor_Mode_select;
extern uint32_t FND_On_Off;
extern uint32_t FND_On;
extern uint8_t b_key ;
extern bool Break ;  
extern bool bAction ;
extern bool Midle_button ;
extern int testtest;
 extern bool Midle_PU ;
 extern bool PU ;
#define DEBUG
